...
#define MAX_SHADOWED_OTHER_LIGHTS_COUNT 16
...
CBUFFER_START(_CustomShadows)
    ...
    float4x4 _OtherShadowMatrices[MAX_SHADOWED_OTHER_LIGHTS_COUNT];
    float4 _OtherShadowTiles[MAX_SHADOWED_OTHER_LIGHTS_COUNT];
...
ShadowData GetShadowData(Surface surfaceWS)
{
    ...
    //级联之外不渲染阴影
    //_CascadeCount为0时没有方向光也就没有级联，不考虑最外层的级联阴影强度衰减，使用上面的最远阴影距离渐隐
